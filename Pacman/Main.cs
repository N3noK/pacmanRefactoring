...
namespace Pacman
{
  public partial class Main : Form
  {
    ...
    private void drawGrid()
    {
      ...
      int row = 0;
      int col = 0;
      for (int i = 0; i < _mauer.Grid.Length; i++)
      {
    ...
    {
      if (_mauer.Grid[ pacman.Y, pacman.X] == 0)
      {
        score += 5;
        lblScore.Text = Convert.ToString(score);
        _mauer.Grid[ pacman.Y, pacman.X] = 2;
      }
    }
    ...
    private void loseLife() 
    {
      ...
      if (lives == 0)
      {
        level = 1;
        tmrStep.Enabled = false;
        MessageBox.Show("You score is: " + score, "Game Over...");
        resetProgress();
    ...
    private void setGrid()
    {
      if (level % 2 == 0)
      {
        ...
        {
          for (int y = 0; y < 20; y++)
          { _mauer.Grid[x, y] = _mauer.Grid2[x, y]; }
        }
      }
      else
      {
        ...
        {
          for (int y = 0; y < 20; y++)
          { _mauer.Grid[x, y] = _mauer.Grid1[x, y]; }
        }
      }
